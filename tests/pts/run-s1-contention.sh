...
echo "   CSV:       tests/pts/inputs/s1-s5/s1-s5-1000-user-sessions.csv"
...
echo "   Current durability: kafka_ack (pinned in code)"
...
echo ""
echo "=== S1 done. Evidence at: artifacts/pts/evidence/incoming/${LABEL}/ ==="
