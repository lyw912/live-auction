...
BID_ENGINE_RESPONSE_DURABILITY="${BID_ENGINE_RESPONSE_DURABILITY:-kafka_ack}"
...
BID_REDIS_GUARD_MAX_STALENESS="${BID_REDIS_GUARD_MAX_STALENESS:-1500ms}"
...
(
  ...
  BID_ENGINE_MODE="$BID_ENGINE_MODE" \
  BID_ENGINE_RESPONSE_DURABILITY="$BID_ENGINE_RESPONSE_DURABILITY" \
  BID_LANE_WORKERS="$BID_LANE_WORKERS" \
  BID_LANE_QUEUE_SIZE="$BID_LANE_QUEUE_SIZE" \
  BID_LANE_QUEUE_TIMEOUT="$BID_LANE_QUEUE_TIMEOUT" \
  BID_REDIS_GUARD_MAX_STALENESS="$BID_REDIS_GUARD_MAX_STALENESS" \
  BID_REDIS_GUARD_TIMEOUT="$BID_REDIS_GUARD_TIMEOUT" \
...
echo "- Exploration profile: ADMISSION_ENABLED=false BID_ENGINE_MODE=$BID_ENGINE_MODE BID_ENGINE_RESPONSE_DURABILITY=$BID_ENGINE_RESPONSE_DURABILITY REDIS_ADDR=$REDIS_ADDR KAFKA_BROKERS=$KAFKA_BROKERS"
