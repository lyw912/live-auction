...
| `S2-read-interference` | Reader RPS impact on bid path | PTS RPS or independent-ECS k6 | `../load/s2-read-interference.js`; `prepare-s2-read-interference-pressure.sh` | 20/s -> 60/s -> 100/s bid attempts plus 200/s -> 600/s -> 1000/s HTTP reads; do not reuse S3 fanout samplers | bid p99 under read load, read p99 by route, DB pool wait, correctness and convergence |
