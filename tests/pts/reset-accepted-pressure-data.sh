...
export SESSION_CSV="${SESSION_CSV:-pts_accepted_sessions.csv}"
export JMX_PATH="${JMX_PATH:-$ROOT_DIR/tests/pts/live-auction-accepted-pressure.jmx}"
...
echo "- JMX: tests/pts/live-auction-accepted-pressure.jmx"
