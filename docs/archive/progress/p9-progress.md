...
> 2026-05-31 supersession notice: this is a historical trust/max-bid/diagnostics progress ledger. Max Bid/Pre-Bid remains a special product path and must not be silently folded into the Redis hot engine without a current ADR and invariant proof.
