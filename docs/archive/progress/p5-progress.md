...
> 2026-05-31 supersession notice: this is a historical UI progress ledger. It remains useful for UI evidence lookup, but current architecture/evidence rules live in `docs/current/`.
