...
> 2026-05-31 supersession notice: this is a historical progress ledger. It is useful for auth/ACL/security/payment context, but not current hot-bid architecture authority. For new work read `docs/current/README.md` and `docs/archive/progress-history-map.md`.
