...
> 2026-05-31 supersession notice: this is a historical H5 UI progress ledger. Old PostgreSQL-truth wording is superseded for the current hot-bid path by `docs/current/architecture.md`; UI/recovery lessons remain useful when they do not conflict with current docs.
