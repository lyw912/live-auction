...
Those now live in the `互动福利` bottom sheet. The sheet remains fully interactive: task completion, Q&A entry, leaderboard entry, follow, team selection, 福袋 participation, and reward reveal still call real APIs.
