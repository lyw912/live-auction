...
- B4 Recap includes backend/PC host recap plus H5 buyer-safe share/highlight card, copy action, and downloadable SVG highlight card. Generated video/highlight clips remain missing because no video rendering/transcoding service or licensed template pack is present.
