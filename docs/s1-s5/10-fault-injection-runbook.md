...
- verifier output under `/tmp/live-auction-evidence/<label>/`;
- run review using `docs/s1-s5/00-overview.md`;
...
`docs/s1-s5/11-fault-test-matrix.md`.
...
6. Write run review from `docs/s1-s5/00-overview.md`.
