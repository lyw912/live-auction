...
- [ ] Current docs read: `docs/README.md`, `docs/design/01-architecture.md`, `docs/design/02-performance-correctness-contract.md`, `docs/design/03-runtime-profiles.md`, `docs/design/04-evidence-policy.md`.
- [ ] Current PTS manifest read: `tests/pts/MANIFEST.md`.
- [ ] Run-review template ready: `docs/s1-s5/00-overview.md`.
- [ ] Fault scope decided: `docs/s1-s5/10-fault-injection-runbook.md`.
- [ ] Git SHA recorded.
...
- [ ] Session CSV generated by the reset script and recorded in the run notes.
...
- [ ] Preflight output exists under the run artifact directory, e.g. `/tmp/live-auction-evidence/before-<run-label>/`.
...
- [ ] CSV path recorded from reset output.
...
- [ ] Evidence exists under the run artifact directory, e.g. `/tmp/live-auction-evidence/<report-id-or-label>/`.
...
- [ ] Write review using `docs/s1-s5/00-overview.md`.
- [ ] Classify the run using `docs/design/04-evidence-policy.md`.
- [ ] Keep raw artifacts outside the committed `docs/` tree.
- [ ] Promote only compact summaries, charts, and conclusions into `docs/s1-s5/` or `docs/judge/` when they are intended for reviewers.
