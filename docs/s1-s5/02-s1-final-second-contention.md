...
(see [README](00-overview.md) §1) does not apply here. Measuring "1000 one-shot
...
- **Citing accepted-TPS as the headline.** Report decision p99 + decisions/sec;
  accepted-TPS is the price-ladder artifact (see [metrics-and-slo](01-metrics-and-slo.md) M1).
