...
> by [s2-s3-expanded-test-design.md](07-s2-s3-expanded-design.md).
...
> [scale-out story](08-scale-out-and-ceilings.md) (room-sharded gateways
...
[pts-playbook §4](13-pts-playbook.md)):
```
...
- **Hold counted as latency.** If `ws-fanout-receive` p99 is tens of seconds, the
  hold leaked into elapsed — split samplers per [playbook §4](13-pts-playbook.md)
  (`58A5X7KG`).
