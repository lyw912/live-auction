...
| P3-D15 | Outbox second-order pressure is the next bottleneck candidate after P3-R4. | EVIDENCE_GATED | `docs/evidence/p3-13-pg-hot-row-drilldown-2026-05-25.md`. | P3-R5 must measure backlog growth, drain rate, delivery lag, table/update/dead-tuple evidence, and claim/update plan before CDC/partitioning decisions. |
...
|---:|---|---|
| 1 | Does outbox stay fixed under longer and multi-room pressure? | Backlog/lag/table/update evidence after claim fix and relay leases. |
